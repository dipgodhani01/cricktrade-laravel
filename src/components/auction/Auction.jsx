...
function Auction() {
  ...
  useEffect(() => {
    if (players && players.length > 0) {
      ...
      setCurrentBid(players[i]?.minimum_bid || 0);
  ...
  const handleTeamClick = (team) => {
    ...
    console.log("Bid Increment :", selectedAuction.bid_increment);
        ...
        <div className="min-h-screen w-full bg-black flex flex-col lg:flex-row gap-6 p-4">
          ...
          <div className="w-full lg:w-[55%] text-white flex flex-col">
            ...
            <div className="mt-10 flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <button className="py-2 px-8 bg-green-600 hover:bg-green-700 text-white rounded shadow transition">
                Sold
              </button>
